#!/usr/bin/env python
"""Direct handler benchmark - no LLM needed."""
...
from agent.runtime.state import AgentState, TOKEN_BUDGETS
...
def main():
    print("=" * 60)
    print("KRYTH HANDLER BENCHMARK WAVE 2 - DIRECT TEST")
    print("=" * 60)
    ...
    print("\n=== HANDLER BENCHMARKS ===")
    benchmarks = [
        ("1. read this project", summarize_project, (".")),
        ("2. find routes", run_search, ("find routes", ".")),
        ("3. trace auth flow", run_search, ("trace auth flow", ".")),
        ("4. run this project", run_and_verify, (".")),
    ]
    ...
    print("TOKEN BUDGETS")
    print("=" * 60)
    for intent, budget in TOKEN_BUDGETS.items():
        print(f"  {intent:10s}: {budget:>6d}")
