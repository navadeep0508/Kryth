...
class SystemPrompt:
	def __init__(
		...
		is_browser_agent_model: bool = False,
		...
		self.is_browser_agent_model = is_browser_agent_model
	...
	def _load_prompt_template(self) -> None:
		...
		try:
			...
			if self.is_browser_agent_model:
				if self.flash_mode:
					template_filename = 'system_prompt_browser_agent_flash.md'
				elif self.use_thinking:
					template_filename = 'system_prompt_browser_agent.md'
				else:
					template_filename = 'system_prompt_browser_agent_no_thinking.md'
