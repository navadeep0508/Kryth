...
from browser_agent.utils import (
	URL_PATTERN,
	_log_pretty_path,
	check_latest_browser_agent_version,
	get_browser_agent_version,
...
class Agent(Generic[Context, AgentStructuredOutput]):
	...
	def __init__(
		...
		**kwargs,
		...
		self.agent_directory = base_tmp / f'browser_agent_agent_{self.id}_{timestamp}'
		...
		self._set_browser_agent_version_and_source(source)
		...
		is_browser_agent_model = 'browser-use/' in self.llm.model.lower()
		...
		self._message_manager = MessageManager(
			...
			system_message=SystemPrompt(
				...
				is_browser_agent_model=is_browser_agent_model,
	...
	def _set_browser_agent_version_and_source(self, source_override: str | None = None) -> None:
	...
	async def _log_agent_run(self) -> None:
		...
		if CONFIG.BROWSER_USE_VERSION_CHECK:
			latest_version = await check_latest_browser_agent_version()
