...
from browser_agent.llm.messages import BaseMessage, ContentPartTextParam, SystemMessage
from browser_agent.llm.schema import SchemaOptimizer
from browser_agent.llm.vercel.serializer import VercelMessageSerializer
...
class ChatVercel(BaseChatModel):
	...
	Examples:
		```python
	        from browser_agent import Agent, ChatVercel
