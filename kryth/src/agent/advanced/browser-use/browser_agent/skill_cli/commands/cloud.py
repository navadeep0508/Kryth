...
def _get_config_path() -> Path:
	from browser_agent.skill_cli.utils import get_config_path

	return get_config_path()


def _read_config() -> dict:
	from browser_agent.skill_cli.config import read_config

	return read_config()


def _write_config(data: dict) -> None:
	from browser_agent.skill_cli.config import write_config
