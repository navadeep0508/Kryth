...
Example usage:
    ...
    from browser_agent.mcp.client import MCPClient
...
from browser_agent.agent.views import ActionResult
from browser_agent.telemetry import MCPClientTelemetryEvent, ProductTelemetry
