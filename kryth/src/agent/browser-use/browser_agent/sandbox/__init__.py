...
Example:
    from browser_agent.sandbox import sandbox, SSEEvent, SSEEventType
...
from browser_agent.sandbox.sandbox import SandboxError, sandbox
from browser_agent.sandbox.views import (
	BrowserCreatedData,
	ErrorData,
	ExecutionResponse,
	LogData,
