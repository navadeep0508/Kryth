...
def handle(yes: bool = False) -> dict:
	...
	from browser_agent.skill_cli.profile_use import get_profile_use_binary
...
def _check_package() -> str:
	...
	try:
		...
		version = getattr(browser_agent, '__version__', 'unknown')
...
def _install_profile_use() -> bool:
	...
	try:
		from browser_agent.skill_cli.profile_use import download_profile_use
