...
from browser_agent_sdk import ParameterSchema, SkillResponse
...
class Skill(BaseModel):
	...
	def parameters_pydantic(self, exclude_cookies: bool = False) -> type[BaseModel]:
		...
		"""
		from browser_agent.skills.utils import convert_parameters_to_pydantic
	...
	def output_type_pydantic(self) -> type[BaseModel] | None:
		...
		from browser_agent.skills.utils import convert_json_schema_to_pydantic
